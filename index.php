...
<html lang="es">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="public/css/templates/bootstrap.min.css" rel="stylesheet">
    <link href="public/css/templates/header_admin.css" rel="stylesheet">
...
<header id="header">
  <div class="container">
    <div class="row">
      <div class="col-md-10">
        <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> ScriptWeb </h1>
      </div>
      <div class="col-md-2">
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="list-group">
          ...
          <a href="index.html" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Paginas <span class="badge">39</span></a>
          <a href="index.html" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Posts <span class="badge">45</span></a>
          <a href="index.html" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Usuarios <span class="badge">112</span></a>
        </div>
